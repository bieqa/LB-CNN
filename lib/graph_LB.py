"""
Original code is "graph.py" from [1] (https://github.com/mdeff/cnn_graph)
including functions regarding graph Laplacian
...
Apr. 02, 2020  Modified by Shih-Gu Huang, 
    adding parameter "algo" (='LB' or 'gL') into lmax() for Laplace-Beltrami operator
"""
...
def lmax(L, normalized=False, algo='LB'):
    ...
    if normalized:
        ...
        if algo == 'gL':
            ...
            return scipy.sparse.linalg.eigs(L, k=1, which='LM', return_eigenvectors=False)[0].real     
